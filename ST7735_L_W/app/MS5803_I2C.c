...
void MS5803_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = (GPIO_Pin_9 | GPIO_Pin_5 | GPIO_Pin_15);
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(GPIOB,&GPIO_InitStructure);

	GPIOB->BSRR |= GPIO_BSRR_BS5 | GPIO_BSRR_BS12 | GPIO_BSRR_BS13 | GPIO_BSRR_BS9 | GPIO_BSRR_BS15;
...
void MS5803_getFullData(temperature_units units, precision _precision, float Data[])
{
	...
	float temperature_reported = (float)(_temperature_actual) / 100;
	...
	Data[1] = (float)(_pressure_actual)/10;
}
