...
void readCalibration(long C[])
{
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	result1 = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	inbyte1 = SPI_I2S_ReceiveData(SPI2);
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	result2 = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	inbyte2 = SPI_I2S_ReceiveData(SPI2);
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	result3 = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	inbyte3 = SPI_I2S_ReceiveData(SPI2);
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	result4 = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	inbyte4 = SPI_I2S_ReceiveData(SPI2);
...
void readData(long C[], long long DATA[])
{
	...
	//2nd order compensation only for T > 0Ã‚Â°C
	//long long dT2;
	//float TEMPCOMP;
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	tempMSB = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	tempLSB = SPI_I2S_ReceiveData(SPI2);
	...
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	presMSB = SPI_I2S_ReceiveData(SPI2);
	SPI_I2S_SendData(SPI2, 0x00);
	while (!(SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_RXNE) == SET));
	presLSB = SPI_I2S_ReceiveData(SPI2);
